// Get the WebGL context.
            var canvas = document.getElementById('canvasButterfly');
            ...
            gl.vertexAttrib4f(colAttrib, 0.1, 0.7, 1, 1);
            gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, iboTris);
            ...
            function createVertexData(){
                ...
                for(var i=0, u=-2; i <= n; i++, u += du) {
                    ...
                    for(var j=0, v=-2; j <= m; j++, v += dv){
                        ...
                        vertices[iVertex * 3] = x * 0.1;
                        vertices[iVertex * 3 + 1] = y * 0.1;
                        vertices[iVertex * 3 + 2] = z * 0.1;
